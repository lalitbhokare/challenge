...
public class AccountsController {
  ...
  @PostMapping(path="/{accountFromId}/{accountToId}/{amount}", consumes = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Object> transferAmount(@PathVariable String accountFromId, @PathVariable String accountToId, @PathVariable BigDecimal amount) {
